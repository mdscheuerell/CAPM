...
```{r plot_betas_v1, fig.height=5, fig.width=9}
...
```{r plot_betas_v2, fig.height=5, fig.width=9}
betas <- betas[,names_mat$ID]
...
## v3: fully unconstrained

```{r CAPM_v3, cache=TRUE, eval=FALSE}
## empty list for model results
mod_res <- vector("list", length(mpg_ID))
## empty beta forecasts
betas4 <- betas4_se <- NULL
...
```{r plot_betas_v3, fig.height=5, fig.width=9, eval=FALSE}
betas <- betas[,names_mat$ID]
