...
## v1: a static; b diag & unequal

```{r CAPM_v1_3, cache=TRUE}
## empty list for model results
mod_res <- vector("list", length(mpg_ID))
## empty beta forecasts
betas4 <- betas4_se <- NULL
...
```{r plot_betas_v1_3, fig.height=5, fig.width=9}
betas <- betas[,names_mat$ID]
...
## v4: a diag & unequal; b diag & unequal
...
```{r plot_betas_v4_1, fig.height=5, fig.width=9}
betas <- betas[,names_mat$ID]
